...
const player = new Player({
	...
	animations:{
		...
		idleleft:{
			imageSrc:'./CIdle (32x32) - Left.png',
			framerate:11,
			framebuffer: 3,
		},
		run:{
			imageSrc:'./CRun (32x32).png',
			framerate:12,
			framebuffer: 3,
		},
		jump:{
			imageSrc:'./CJump (32x32).png',
			framerate:1,
			framebuffer: 1,
		},
		jumpleft:{
			imageSrc:'./CJump (32x32) - Left.png',
			framerate:1,
			framebuffer: 1,
		},
		fall:{
			imageSrc:'./CFall (32x32).png',
			framerate:1,
			framebuffer: 1,
		},
		fallleft:{
			imageSrc:'./CFall (32x32) - left.png',
			framerate:1,
			framebuffer: 1,
		},
		runleft:{
			imageSrc:'./CRun (32x32) - Left.png',
			framerate:12,
			framebuffer: 3,
		},
	},
